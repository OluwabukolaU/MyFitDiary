  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="relative bg-white text-gray-800 p-8 rounded-lg shadow-2xl max-w-md w-full mb-10 transform transition-all duration-300 hover:scale-105"
      >
        <img
        ...
        <div className="mb-6">
          <label
            className="block text-lg font-semibold mb-2 text-blue-600"
            htmlFor="weeklyWeightLoss"
          >
          ...
          {weeklyWeightLoss && (
            <p className="mt-2 text-gray-800">
              To lose {weeklyWeightLoss} kg, you need to burn approximately{" "}
        ...
        <div className="mb-6">
          <label
            className="block text-lg font-semibold mb-2 text-green-600"
            htmlFor="targetDate"
          >
            Target Date
          </label>
        ...
        <div className="mb-6">
          <label
            className="block text-lg font-semibold mb-2 text-purple-600"
            htmlFor="calorieSource"
          >
            Source of Calories
          </label>
          <select
          ...
          {targets.map((target, index) => (
            <li
              ...
              className={`p-6 border rounded-lg ${
                target.completed ? "bg-green-200" : "bg-white"
              } shadow-md flex-1 min-w-[300px] transform transition-all duration-300 hover:scale-105`}
            >
              <div>
                <p className="font-bold">
                  Weight Loss Rate: {target.weeklyWeightLoss} kg
                </p>
              ...
              <div className="flex space-x-2 mt-4">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg ${
                    target.completed ? "bg-yellow-500" : "bg-green-500"
